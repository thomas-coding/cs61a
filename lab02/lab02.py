...
def count_cond(condition):
    ...
    def g(n):
        ...
        i = 1
        while(i <= n):
            if(condition(n, i)): # satisfy condition
                count += 1
            i += 1
        return count
    return g
...
def cycle(f1, f2, f3):
    ...
    def cycle_identity(z):
        return z

    def h(y):
        if(y == 0):
            return cycle_identity
        ...
        current_f = f1
        new_f = f1
        while(y >= 2): # Use composer to construct new function
            if(current_f == f1):
                next_c = f2
            elif(current_f == f2):
                next_c = f3
